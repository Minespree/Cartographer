...
[![License](https://img.shields.io/github/license/Minespree/Cartographer.svg)](LICENSE)
[![Documentation](https://img.shields.io/badge/docs-available-brightgreen.svg)](https://github.com/Minespree/Docs)

This is the code that powered the map config creator/editor tool of the former Minespree Network.
...
To build Cartographer, the following will need to be installed and available from your shell:
...
Next, move the produced artifact on `target/` to your Spigot (test) server `plugins/` directory and restart the instance.

Finally, run one of the map creation commands to start the process of creating a new map. You can check the [Docs](https://github.com/Minespree/Docs) for more information about this process.
...
* Map creation wizard
* BlockWars map schema
* Clash map schema
* Double Trouble map schema
* SkyWars map schema
* Thimble map schema
...
Cartographer is free software: you can redistribute it and/or modify it under the terms of the GNU Affero General Public License as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version.
